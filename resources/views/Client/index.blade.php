        ...
        <thead>
            ...
            @foreach($clients as $client)
                <tr>
                    ...
                    <td>{{$client->email}}</td>
                    <td>@if($client->status) <span style="color: white;background-color: #1da754;padding: 5px; border-radius: 3px">Active</span> @else <span style="color: white;background-color: #a71d1d;padding: 5px; border-radius: 3px">Inactive</span> @endif</td>
                    <td>
...
{{--                        <a class="btn" href="/Client/{{$client->id}}/Delete" style="background-color: #c71111;color: white"><i class="fa fa-trash" aria-hidden="false"></i></a>--}}
                        ...
                        <a class="btn" id="myBtn" onclick="view_client_data('{{$client->id}}')"  data-toggle="modal" data-target="#client_modal" style="background-color: #000000;color: white"><i class="fa fa-eye" aria-hidden="false"></i></a>
